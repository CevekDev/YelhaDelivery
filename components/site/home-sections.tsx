...
import { ArrowRight, CreditCard, Leaf, ShoppingBag, Sparkles, Truck } from 'lucide-react';
import type { MenuItem, Restaurant } from '@/types/database';
import type { Template } from '@/lib/templates';
import { formatPrice } from '@/lib/utils';
import { type Highlight, MediaPlaceholder, PrimaryCta } from './home-shared';
...
export function Highlights({ template, highlights }: { template: Template; highlights: Highlight[] }) {
...
export function Gallery({ template, gallery }: { template: Template; gallery: string[] }) {
  const style = template.heroStyle;
